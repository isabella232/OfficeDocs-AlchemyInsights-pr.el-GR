...
<p>Εάν το εξωτερικό χρήστη έχει προσκληθεί και δεν είναι δυνατή η πρόσβαση στο περιεχόμενο, Παρακαλώ δοκιμάστε να επισκεφθείτε τις παρακάτω συνδέσεις.</p> <ul> <li style="font-weight: 400;"><a href="https://support.office.com/en-us/article/Error-message-when-an-external-user-accepts-a-SharePoint-Online-invitation-by-using-another-account-f0d34413-ea7c-42c7-a485-c4e5d421e5f0">Μήνυμα λάθους όταν εξωτερικό χρήστη αποδέχεται μια πρόσκληση σε ηλεκτρονική SharePoint χρησιμοποιώντας έναν άλλο λογαριασμό</a></li> <li style="font-weight: 400;"><a href="https://support.office.com/client/d678b57a-53ad-4414-9423-d8726a0c532f">Η πρόσβαση σε έναν κοινόχρηστο φάκελο</a></li> <li style="font-weight: 400;"><a href="https://docs.microsoft.com/en-us/sharepoint/sharepoint-onedrive-error-message">OSE κοινή χρήση σφάλματα στο Sharepoint και OneDrive</a></li> </ul>
