---
title: Μηνύματα ειδοποίησης συνδρομής σε Microsoft 365 εφαρμογές
ms.author: pebaum
author: pebaum
manager: scotv
ms.audience: Admin
...
ms.locfileid: "54049569"
---
# <a name="subscription-notice-messages-in-microsoft-365-apps"></a>Μηνύματα ειδοποίησης συνδρομής σε Microsoft 365 εφαρμογές
