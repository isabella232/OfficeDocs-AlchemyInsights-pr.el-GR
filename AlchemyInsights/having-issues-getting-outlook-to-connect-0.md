---
title: Αντιμετωπίζετε προβλήματα κατά Outlook να συνδεθείτε;
ms.author: pebaum
...
ms.locfileid: "54056310"
---
# <a name="having-issues-getting-outlook-to-connect"></a>Αντιμετωπίζετε προβλήματα κατά Outlook να συνδεθείτε;

Εντοπίσαμε ότι οι Outlook δεν έχουν ρυθμιστεί ώστε να λειτουργούν σωστά κάτω από τους ακόλουθους τομείς:
