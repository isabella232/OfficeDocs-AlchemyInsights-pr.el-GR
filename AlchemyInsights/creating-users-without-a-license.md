...
- Εάν χρειάζεστε μια διεύθυνση ηλεκτρονικού ταχυδρομείου ομάδας για πολλά άτομα, ανατρέξτε στο θέμα [Δημιουργία κοινόχρηστου γραμματοκιβωτίου](https://docs.microsoft.com/office365/admin/email/create-a-shared-mailbox).
