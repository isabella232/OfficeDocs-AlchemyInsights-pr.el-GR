...
Εξετάσαμε το αίτημά σας και καθορίσαμε ότι αυτός ο οργανισμός δεν είναι επιλέξιμος ως μη κερδοσκοπικός οργανισμός της Microsoft.
  
Για να αγοράσετε το Office 365 εμπορικά, ανατρέξτε στο θέμα [διαθέσιμες προσφορές](https://portal.office.com/AdminPortal/Home).
