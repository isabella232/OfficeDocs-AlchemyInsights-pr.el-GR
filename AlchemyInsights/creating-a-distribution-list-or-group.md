...
**Σημείωση:** Ένας διαχειριστής πρέπει να διαχειρίζεται τη συμμετοχή σε μια ομάδα διανομής. Εάν θέλετε οι χρήστες να διαχειρίζονται τις δικές τους λίστες μελών ομάδας, ίσως θελήσετε να λάβετε υπόψη [τις ομάδες του Office 365.](https://support.office.com/article/b565caa1-5c40-40ef-9915-60fdb2d97fa2)
