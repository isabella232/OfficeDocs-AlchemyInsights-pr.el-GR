...
Εάν θέλετε όλα τα μέλη να βλέπουν τα απεσταλμένα μηνύματα ηλεκτρονικού ταχυδρομείου, στο  Κέντρο διαχείρισης Microsoft 365, επεξεργαστείτε τις λεπτομέρειες του κοινόχρηστου γραμματοκιβωτίου και επιλέξτε "Επεξεργασία \> **απεσταλμένων".**
