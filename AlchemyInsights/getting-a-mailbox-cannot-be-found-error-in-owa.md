...
---
# <a name="getting-a-mailbox-not-found-error-in-outlook-on-the-web"></a>Γρήγορα ένα γραμματοκιβώτιο δεν βρέθηκε σφάλμα στο Outlook στο web;
...
3. Στη σελίδα **άδειες προϊόντων** που ανοίγει, επιλέξτε την κατάλληλη τιμή **θέσης** και αναθέσετε μια άδεια χρήσης που περιέχει Exchange Online (ανάπτυξη της άδειας χρήσης για να δείτε τις λεπτομέρειές του). Όταν τελειώσετε, κάντε κλικ στην επιλογή **Αποθήκευση**.
