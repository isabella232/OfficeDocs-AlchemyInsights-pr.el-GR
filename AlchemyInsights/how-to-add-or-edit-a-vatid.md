...
ms.locfileid: "36664320"
---
# <a name="how-to-add-or-edit-a-vatid"></a>Πώς μπορείτε να προσθέσετε ή να επεξεργαστείτε μια VatID

1. Στο Κέντρο διαχείρισης Microsoft 365, μεταβείτε στην **χρέωσης** \> σελίδα [υπηρεσιών & προϊόντα](https://go.microsoft.com/fwlink/p/?linkid=842054) .
...
Για να μάθετε περισσότερα, ανατρέξτε στο θέμα [Τι φόρο θα θα χρεωθεί για Office 365;](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/what-tax-will-i-be-charged)

**Πρόσθετοι πόροι**

Για να [προσθέσετε το Αναγνωριστικό ΦΠΑ](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/what-tax-will-i-be-charged?view=o365-worldwide#add-your-vat-id-eu-countries-only).