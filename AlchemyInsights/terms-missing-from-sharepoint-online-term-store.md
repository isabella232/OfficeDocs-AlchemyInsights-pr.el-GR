...
ms.locfileid: "54039606"
---
# <a name="terms-missing-from-sharepoint-online-term-store"></a>Όροι που λείπουν από SharePoint Online Term Store

Οι όροι στο SharePoint Online Term Store που αναμένατε να δείτε δεν εμφανίζονται ή εμφανίζονται κατά διαλείπουσα εμφάνιση.
