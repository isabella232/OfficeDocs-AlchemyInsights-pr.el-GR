...
Εάν θέλετε να αλλάξετε τον τομέα για μια ομάδα Microsoft 365 κατά τη δημιουργία, ακολουθήστε τα βήματα στο θέμα [Επιλογή του τομέα που θα χρησιμοποιηθεί κατά τη δημιουργία ομάδων του Microsoft 365](https://docs.microsoft.com/office365/admin/create-groups/choose-domain-to-create-groups).
