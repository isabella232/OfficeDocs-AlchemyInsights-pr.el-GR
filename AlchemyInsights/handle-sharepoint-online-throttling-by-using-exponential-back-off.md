...
Όταν εναλλάσσεστε στο SharePoint Online, η εκθετική τεχνική back off περιμένει σταδιακά μεγαλύτερες χρονικές περιόδους πριν από την επανάληψη του κώδικα που επιταχύνθηκε.
