...
ms.locfileid: "43759764"
---
# <a name="troubleshoot-error-404-file-not-found"></a>Αντιμετώπιση προβλημάτων σφάλματος 404, το αρχείο δεν βρέθηκε

Ένα σφάλμα 404 λαμβάνεται όταν οι χρήστες προσπαθούν να αποκτήσουν πρόσβαση σε μια τοποθεσία ή αρχείο στο SharePoint ή το OneDrive. Αυτό συχνά προκαλείται από τη μετονομασία, μετακίνηση ή διαγραφή μιας τοποθεσίας ή αρχείου ή ομάδας. Για παράδειγμα: Οι χρήστες θα αντιμετωπίσουν ένα σφάλμα 404 που προσπαθεί να αποκτήσει πρόσβαση στη συλλογή τοποθεσιών ρίζας και έχει διαγραφεί.
