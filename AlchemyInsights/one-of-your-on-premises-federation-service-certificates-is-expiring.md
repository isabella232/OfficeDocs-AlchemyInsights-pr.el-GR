...
- Ακολουθήστε τα βήματα στην ενότητα "Σενάριο 1: Το πιστοποιητικό υπογραφής διακριτικού AD FS έληξε" του [σφάλματος "Παρουσιάστηκε πρόβλημα κατά την πρόσβαση στην τοποθεσία" από το AD FS όταν ένας ομόσπονδος χρήστης μπαίνει στο Office 365, το Azure ή το Intune](https://support.microsoft.com/help/2713898/there-was-a-problem-accessing-the-site-error-from-ad-fs-when-a-federat).
    
- Ακολουθήστε τα βήματα στο t[Τρόπος ενημέρωσης ή επιδιόρθωσης των ρυθμίσεων ενός ομόσπονδου τομέα στο Office 365, το Azure ή το Intune](https://support.microsoft.com/help/2647048/how-to-update-or-repair-the-settings-of-a-federated-domain-in-office-3).
