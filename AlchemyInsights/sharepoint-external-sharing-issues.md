---
title: Ο εξωτερικός χρήστης δεν μπορεί να αποκτήσει πρόσβαση σε περιεχόμενο στο SharePoint Online
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="external-user-is-unable-to-access-content-in-sharepoint-online"></a>Ο εξωτερικός χρήστης δεν μπορεί να αποκτήσει πρόσβαση σε περιεχόμενο στο SharePoint Online

Εάν ένας εξωτερικός χρήστης έχει προσκληθεί και δεν είναι σε θέση να αποκτήσει πρόσβαση σε περιεχόμενο, δοκιμάστε να επισκεφθείτε τις παρακάτω συνδέσεις.
