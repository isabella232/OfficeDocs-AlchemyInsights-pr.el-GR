...
Πριν από την εισαγωγή επαφών σε Outlook.com, θα πρέπει να τις εξαγάγετε από την άλλη υπηρεσία παροχής ηλεκτρονικού ταχυδρομείου ως αρχείο .csv. Στη συνέχεια, ακολουθήστε τις παρακάτω οδηγίες.
...
3. Επιλέξτε **Αναζήτηση**, μεταβείτε στο φάκελο όπου αποθηκεύσατε τις επαφές που έχετε εξαγάγει και επιλέξτε **Άνοιγμα**.

Για να μάθετε περισσότερα, ανατρέξτε στο θέμα [Εισαγωγή επαφών σε Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).