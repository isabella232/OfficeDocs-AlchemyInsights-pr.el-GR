...
Πριν από την εισαγωγή επαφών στο Outlook.com, θα πρέπει να τις εξαγάγετε από την άλλη υπηρεσία παροχής ηλεκτρονικού ταχυδρομείου σας ως αρχείο. csv. Στη συνέχεια, ακολουθήστε τις παρακάτω οδηγίες.
...
3. Επιλέξτε **Αναζήτηση**, μεταβείτε στο φάκελο όπου αποθηκεύσατε τις επαφές που εξαγάγατε και επιλέξτε **Άνοιγμα**.
