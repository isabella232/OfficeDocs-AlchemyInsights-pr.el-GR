...
---
# <a name="get-the-a1-plan"></a>Λήψη του Προγράμματος A1

Εάν το Ινστιτούτο σας πληροί τις προϋποθέσεις για το Microsoft 365 για εκπαιδευτικά ιδρύματα, μπορείτε να προσθέσετε τη συνδρομή για το Πρόγραμμα A1 από το **Κέντρο διαχείρισης Microsoft 365**. 

1. Μεταβείτε στην επιλογή **Χρέωση > [Προϊόντα και υπηρεσίες](https://go.microsoft.com/fwlink/p/?linkid=868433)**.

2. Χρησιμοποιήστε το πλαίσιο αναζήτησης για να πραγματοποιήσετε αναζήτηση πληκτρολογώντας "A1".

3. Επιλέξτε τον αριθμό των χρηστών που θα χρησιμοποιήσουν το Πρόγραμμα A1.
