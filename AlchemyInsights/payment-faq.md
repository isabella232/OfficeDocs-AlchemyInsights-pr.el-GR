...
ms.locfileid: "58841901"
---
# <a name="payment-faq"></a>Συνήθεις ερωτήσεις για την πληρωμή

Διαχειριστείτε τις πληρωμές στην **Κέντρο διαχείρισης Microsoft 365**.

- Μεταβείτε **στην ενότητα Χρέωση > Τα προϊόντα [σας](https://go.microsoft.com/fwlink/p/?linkid=842054)** για να εκχωρήσετε ή να αλλάξετε τις μεθόδους πληρωμής της συνδρομής.
- Μεταβείτε **στην ενότητα Χρέωση > [Μέθοδοι πληρωμής](https://go.microsoft.com/fwlink/p/?linkid=2018806)** για να προσθέσετε, να ενημερώσετε, να αντικαταστήσετε ή να διαγράψετε μεθόδους πληρωμής.
...
Για έναν πλήρη οδηγό σχετικά με την πληρωμή για τη συνδρομή σας, ανατρέξτε στο θέμα Τρόπος πληρωμής για τη [συνδρομή σας.](https://docs.microsoft.com/microsoft-365/commerce/billing-and-payments/pay-for-your-subscription)
