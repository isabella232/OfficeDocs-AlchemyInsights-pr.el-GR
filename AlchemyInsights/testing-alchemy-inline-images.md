---
title: Δοκιμή ενσωματωμένων εικόνων alchemy
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "53998332"
---
# <a name="access-the-domains-page"></a>Πρόσβαση στη σελίδα "Τομείς"

Για να αποκτήσετε πρόσβαση στη σελίδα τομέων, απλώς κάντε κλικ σε αυτό το εικονίδιο παρακάτω:
