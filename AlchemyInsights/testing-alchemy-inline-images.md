...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="38f30-102">Πρόσβαση στη σελίδα "τομείς"</span><span class="sxs-lookup"><span data-stu-id="38f30-102">Access the Domains Page</span></span>

<span data-ttu-id="38f30-103">Για να αποκτήσετε πρόσβαση στη σελίδα domain, απλά κάντε κλικ στο παρακάτω εικονίδιο:</span><span class="sxs-lookup"><span data-stu-id="38f30-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="38f30-104">Στη συνέχεια, μπορείτε να προσθέσετε, να τροποποιήσετε ή να καταργήσετε τον τομέα σας.</span><span class="sxs-lookup"><span data-stu-id="38f30-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="38f30-105">Για περισσότερες πληροφορίες, ανατρέξτε στις [Συνήθεις ερωτήσεις για τους τομείς.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="38f30-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
