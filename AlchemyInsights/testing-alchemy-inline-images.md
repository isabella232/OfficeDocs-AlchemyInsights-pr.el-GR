...
ms.locfileid: "36507163"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="3391f-102">Πρόσβαση στη σελίδα τομείς</span><span class="sxs-lookup"><span data-stu-id="3391f-102">Access the Domains Page</span></span>

<span data-ttu-id="3391f-103">Για να αποκτήσετε πρόσβαση στη σελίδα τομείς, απλώς κάντε κλικ το παρακάτω εικονίδιο:</span><span class="sxs-lookup"><span data-stu-id="3391f-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="3391f-104">Στη συνέχεια, μπορείτε να προσθέσετε, να τροποποιήσετε ή να καταργήσετε τον τομέα σας.</span><span class="sxs-lookup"><span data-stu-id="3391f-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="3391f-105">Για περισσότερες πληροφορίες, ανατρέξτε στο θέμα της [τομείς FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="3391f-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
