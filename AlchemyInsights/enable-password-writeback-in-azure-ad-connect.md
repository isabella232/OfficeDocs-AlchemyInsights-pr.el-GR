...
**Σημείωση:** Όταν ένας διαχειριστής επαναφέρει τον κωδικό πρόσβασης ενός χρήστη στην πύλη Azure, εάν αυτός ο χρήστης είναι ομόσπονδος ή ο κωδικός πρόσβασης έχει συγχρονιστεί, ο κωδικός πρόσβασης γράφεται ξανά στην εσωτερική εγκατάσταση. Αυτή η λειτουργικότητα απαιτεί άδεια χρήσης Azure Premium (P1 ή P2) και δεν υποστηρίζεται επί του παρόντος στην πύλη διαχείρισης του Office.
