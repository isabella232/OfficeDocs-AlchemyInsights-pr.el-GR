...
ms.locfileid: "36665436"
---
# <a name="canceling-your-office-365-subscription"></a>Ακυρώσετε τη συνδρομή σας Office 365;

Θα είμαστε Λυπούμαστε για να δείτε μπορείτε να μεταβείτε, αλλά αν θέλετε να ακυρώσετε τη συνδρομή σας, ακολουθούν τις επιλογές σας:
...
- Εάν έχετε λιγότερα από 25 άδειες που έχουν ανατεθεί, μπορείτε να ακυρώσετε τη συνδρομή σας ηλεκτρονικά. Μεταβείτε στην **χρέωσης** \> σελίδα [υπηρεσιών & προϊόντα](https://go.microsoft.com/fwlink/p/?linkid=842054) . Στην ενότητα **Ρυθμίσεις & ενέργειες** , επιλέξετε να **ακυρώσετε τη συνδρομή**.
