...
Οι χρήστες ενδέχεται να σας ζητείται περιοδικά από το Office για πιστοποιήσεις στο SharePoint Online ή στο OneDrive, όταν επιχειρούν να ανοίξουν έγγραφα.
...
Εναλλακτικά, εάν χρησιμοποιείτε καθολικής σύνδεσης (SSO) για τον έλεγχο ταυτότητας, ανατρέξτε σε [αυτό το άρθρο](https://support.microsoft.com/help/4025962/cant-sign-in-after-update-to-office-2016-build-16-0-7967-on-windows-10) αντ ' αυτού.
