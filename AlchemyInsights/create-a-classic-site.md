...
ms.locfileid: "28290346"
---
# <a name="create-a-classic-site"></a>Δημιουργήστε μια τοποθεσία κλασικό

- Μεταβείτε στη [σελίδα "τοποθεσίες" στο στο Κέντρο διαχείρισης του Office 365](https://portal.office.com/adminportal/home#/SitesList)και, στη συνέχεια, επιλέξτε **Προσθήκη μιας τοποθεσίας**. 
...
Για περισσότερες πληροφορίες σχετικά με τη δημιουργία μιας τοποθεσίας classic, ανατρέξτε στο θέμα [Δημιουργία μιας συλλογής τοποθεσιών](https://go.microsoft.com/fwlink/?linkid=866295).
