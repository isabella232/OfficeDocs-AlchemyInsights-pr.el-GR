...
- Εξασφάλιση συμβουλές πολιτικής έχουν **ενεργοποιηθεί** στον κανόνα DLP ακολουθώντας τα βήματα [εδώ](https://docs.microsoft.com/en-us/office365/securitycompliance/use-notifications-and-policy-tips).
    
- Εξασφαλίζεται το **περιεχόμενο ανταποκρίνεται** **απαιτείται** για την ενεργοποίηση του κανόνα που περιγράφονται σε αυτό το άρθρο [εδώ](https://docs.microsoft.com/en-us/office365/securitycompliance/what-the-sensitive-information-types-look-for).
...
Για πρόσθετες πληροφορίες σχετικά με συμβουλές πολιτικής DLP, δείτε: [Εμφάνιση συμβουλών πολιτικής για τις πολιτικές DLP](https://docs.microsoft.com/en-us/office365/securitycompliance/use-notifications-and-policy-tips)
