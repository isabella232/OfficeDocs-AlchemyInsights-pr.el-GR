...
- Εάν έχετε λιγότερα από 25 άδειες που έχουν ανατεθεί, μπορείτε να ακυρώσετε τη συνδρομή σας ηλεκτρονικά. Μεταβείτε στην **χρέωσης** \> [υπηρεσίες & προϊόντα](https://go.microsoft.com/fwlink/p/?linkid=842054). Στην ενότητα **Ρυθμίσεις & ενέργειες** , επιλέξετε να **ακυρώσετε τη συνδρομή**.
