...
---
# <a name="teams-student-licenses"></a>Άδειες χρήσης σπουδαστή για το Teams

Αν έχετε μισθωτή για εκπαιδευτικά ιδρύματα, πρέπει να ενεργοποιήσετε το Microsoft Teams με μη αυτόματο τρόπο:

1. Μεταβείτε στο Κέντρο διαχείρισης Microsoft 365 **Ρυθμίσεις > Ρυθμίσεις > Microsoft Teams**. 
