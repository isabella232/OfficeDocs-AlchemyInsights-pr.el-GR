...
Για οδηγίες, ανατρέξτε [στην ενότητα "Αντιμετώπιση προβλημάτων εγκατάστασης για το Microsoft Defender για τελικό σημείο για Linux".](https://go.microsoft.com/fwlink/?linkid=2144673)
