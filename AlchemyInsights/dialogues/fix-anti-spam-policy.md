---
title: Επιδιόρθωση πολιτικής καταπολέμησης της ανεπιθύμητης αλληλογραφίας
ms.author: v-jmathew
author: v-jmathew
manager: dansimp
audience: Admin
...
ms.locfileid: "50694316"
---
# <a name="fix-anti-spam-policy"></a>Επιδιόρθωση πολιτικής καταπολέμησης της ανεπιθύμητης αλληλογραφίας
...
3. Αναπτύξτε την **επιλογή "Ιδιότητες ανεπιθύμητης** αλληλογραφίας" και εξετάστε **τις ρυθμίσεις "Σήμανση ως ανεπιθύμητης** αλληλογραφίας".
