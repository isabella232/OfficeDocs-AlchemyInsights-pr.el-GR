...
Μπορείτε να κρυπτογραφείτε αυτόματα τα μηνύματα που στέλνουν οι χρήστες σε συγκεκριμένα εξωτερικά άτομα ή εταιρείες. Για να το κάνετε αυτό, εκτελέστε τα ακόλουθα βήματα:
...
3. Στο **πεδίο "Όνομα",** πληκτρολογήστε ένα όνομα για τον κανόνα, όπως "Κρυπτογράφηση μηνυμάτων που αποστέλλονται *DrToniRamos@gmail.com"*.
4. Στην **επιλογή "Εφαρμογή αυτού του κανόνα",** επιλέξτε **τον παραλήπτη > είναι αυτό το άτομο.** 
...
7. Δίπλα στο πεδίο **"Κάντε το εξής",** κάντε κλικ **στην επιλογή "Επιλογή".** 
