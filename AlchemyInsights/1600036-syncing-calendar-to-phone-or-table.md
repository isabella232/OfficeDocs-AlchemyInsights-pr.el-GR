...
ms.locfileid: "29471592"
---
# <a name="issues-synchronizing-your-calendar-to-devices"></a><span data-ttu-id="5a39c-102">Ζητήματα συγχρονισμού του ημερολογίου σας σε συσκευές</span><span class="sxs-lookup"><span data-stu-id="5a39c-102">Issues synchronizing your calendar to devices</span></span>

<span data-ttu-id="5a39c-103">Για την αντιμετώπιση ζητημάτων Συγχρονισμός ημερολογίου σε συσκευές, ανατρέξτε στο θέμα [δεν μπορεί να συγχρονίσει το ημερολόγιο και τις επαφές με το τηλέφωνο ή το tablet](https://support.office.com/article/8479d764-b9f5-4fff-ba88-edd7c265df9f.aspx).</span><span class="sxs-lookup"><span data-stu-id="5a39c-103">To troubleshoot issues synchronizing you calendar to devices, see [Can't sync calendar and contacts with my phone or tablet](https://support.office.com/article/8479d764-b9f5-4fff-ba88-edd7c265df9f.aspx).</span></span>
