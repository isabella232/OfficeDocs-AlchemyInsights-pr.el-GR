...
Εάν θέλετε απλώς να διαγράψετε το χρήστη και δεν σας απασχολεί κανένα από τα δεδομένα του, [ανατρέξτε](https://docs.microsoft.com/office365/admin/add-users/delete-a-user)στο θέμα Διαγραφή χρήστη από τον οργανισμό σας . Αυτό θα ελευθερώσει αμέσως την άδειά τους.
