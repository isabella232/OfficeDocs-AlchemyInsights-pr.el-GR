...
1. Μεταβείτε στο **[Κέντρο ασφάλειας του Office 365 & και](https://sip.protection.office.com/) > ταξινόμησης > ετικέτες ευαισθησίας.**
...
3. Επαναλάβετε αυτά τα βήματα για να δημιουργήσετε περισσότερες ετικέτες. Ωστόσο, εάν θέλετε να δημιουργήσετε μια δευτερεύουσα ετικέτα, επιλέξτε πρώτα τη γονική ετικέτα, κάντε κλικ **στην** επιλογή ... **για** περισσότερες ενέργειες και, στη συνέχεια, κάντε κλικ στην επιλογή **"Προσθήκη δευτερεύουσας ετικέτας".**
4. Όταν έχετε δημιουργήσει όλες τις ετικέτες που χρειάζεστε, εξετάστε τη σειρά τους και, εάν είναι απαραίτητο, μετακινήστε τις προς τα επάνω ή προς τα κάτω. Για να αλλάξετε τη σειρά μιας ετικέτας, κάντε κλικ στην επιλογή **...** για περισσότερες ενέργειες και, **στη** συνέχεια, κάντε κλικ στην επιλογή **"Μετακίνηση προς τα επάνω"** ή **"Μετακίνηση προς τα κάτω".** 
