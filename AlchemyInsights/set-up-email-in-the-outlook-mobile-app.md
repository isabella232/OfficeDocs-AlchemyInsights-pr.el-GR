...
1. Επιλέξτε " **Γρήγορα αποτελέσματα** " Εάν πρόκειται για την πρώτη ρύθμιση ώρας ηλεκτρονικού ταχυδρομείου στην της εφαρμογής για κινητές συσκευές. Διαφορετικά, κτυπήστε το **μενού** και, στη συνέχεια, κτυπήστε στην επιλογή **Ρυθμίσεις** \> **Προσθήκη λογαριασμού** \> **Προσθήκη λογαριασμού ηλεκτρονικού ταχυδρομείου**. 
