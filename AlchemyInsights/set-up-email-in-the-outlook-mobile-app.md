...
4. Εάν είναι [ενεργοποιημένος ο έλεγχος ταυτότητας πολλών παραγόντων,](https://docs.microsoft.com/office365/admin/security-and-compliance/set-up-multi-factor-authentication) επαληθεύστε τη μέθοδο που έχετε ρυθμίσει (εξαψήφιος κωδικός, τηλεφωνική κλήση ή εφαρμογή Microsoft Authenticator).
