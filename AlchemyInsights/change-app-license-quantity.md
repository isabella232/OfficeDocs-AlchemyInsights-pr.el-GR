...
ms.locfileid: "47733939"
---
# <a name="change-app-license-quantity"></a>Αλλαγή ποσότητας άδειας χρήσης εφαρμογής

Μπορείτε να προβάλετε ή να αλλάξετε τον αριθμό των αδειών χρήσης που έχετε και να τους εκχωρήσετε σε χρήστες στο κέντρο διαχείρισης του Microsoft 365. 
