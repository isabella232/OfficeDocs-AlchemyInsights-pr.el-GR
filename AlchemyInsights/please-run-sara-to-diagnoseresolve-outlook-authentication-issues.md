...
Σας συνιστούμε να χρησιμοποιείτε το [Outlook διατηρεί ζητά τον κωδικό πρόσβασής μου](https://aka.ms/SaRA-OutlookPwdPrompt-Alchemy) διαγνωστικών στον υπολογιστή που έχει επηρεαστεί για να αντιμετωπίσετε ζητήματα όπου το Outlook ζητά συνεχώς για έναν κωδικό πρόσβασης. Αυτό [SaRA](https://diagnostics.office.com/#/) διαγνωστικών δεν αυτοματοποιημένων ελέγχων και επιστρέφει τις πιθανές λύσεις που μπορείτε να χρησιμοποιήσετε για να αντιμετωπίσετε τυχόν προβλήματα που εντοπίστηκαν.
