...
Για να διαγνώσετε και να διορθώσετε τα ζητήματα συνδεσιμότητας Outlook, μπορείτε να εκτελέσετε το [εργαλείο συνδεσιμότητας Outlook](https://aka.ms/SaRA-OutlookDisconnect) στον υπολογιστή που επηρεάζεται. 
