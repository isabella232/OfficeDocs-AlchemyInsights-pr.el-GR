...
1. Στο κέντρο διαχείρισης, **μεταβείτε** στην ενότητα Περιοχή εγκατάστασης \> **Domains** και επιλέξτε το όνομα τομέα που θέλετε να αλλάξετε.

2. Εισαγάγετε τις πληροφορίες που ευθυγραμμίζεται με την ιστοσελίδα σας με τη νέα υπηρεσία παροχής φιλοξενίας.

Για να μάθετε περισσότερα, ανατρέξτε στο θέμα [Ενημέρωση εγγραφών DNS για να διατηρήσετε τον ιστότοπό σας με την τρέχουσα υπηρεσία παροχής φιλοξενίας](https://docs.microsoft.com/microsoft-365/admin/dns/update-dns-records-to-retain-current-hosting-provide).
