...
Ως μέρος της διαδικασίας μετακίνησης της δημόσιας τοποθεσίας Web του Microsoft 365 σε άλλη υπηρεσία παροχής φιλοξενίας, πιθανότατα θα χρειαστεί να κάνετε αλλαγές στις εγγραφές τομέα σας.
...
Για να μάθετε περισσότερα σχετικά με τη διακοπή της δημόσιας τοποθεσίας, ανατρέξτε στο θέμα "Δημόσιες τοποθεσίες Web του [SharePoint Online" που θα καταργηθούν.](https://support.office.com/article/sharepoint-online-public-websites-to-be-discontinued-e86bfd2f-5c7d-446f-a430-7cfcc0130916)
