...
Εάν θέλετε να επιτρέπεται στους διαχειριστές συλλογής τοποθεσιών να συνδεθείτε από μια νέα εντολή μενού μας προσθέτετε τοποθεσίες ομάδας κλασική νέες ομάδες, δεν χρειάζεται να κάνετε τίποτα. Εάν, ωστόσο, θέλετε να απενεργοποιήσετε αυτήν την επιλογή, θα πρέπει να αλλάξετε την προεπιλεγμένη ρύθμιση. [Μάθετε πώς](https://go.microsoft.com/fwlink/?linkid=2004316). Σημειώστε ότι καθολική και θα είναι πάντα δυνατή σύνδεση τοποθεσίες με νέες ομάδες χρησιμοποιώντας το PowerShell cmdlet ή API "διαχειριστές" του SharePoint στο Office 365.
