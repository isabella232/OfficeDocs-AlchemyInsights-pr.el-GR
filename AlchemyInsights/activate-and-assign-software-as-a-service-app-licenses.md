...
---
# <a name="activate-and-assign-software-as-a-service-app-licenses"></a>Ενεργοποίηση και εκχώρηση αδειών χρήσης εφαρμογών για λογισμικό ως υπηρεσία 

## <a name="to-activate-apps"></a>Για να ενεργοποιήσετε τις εφαρμογές
