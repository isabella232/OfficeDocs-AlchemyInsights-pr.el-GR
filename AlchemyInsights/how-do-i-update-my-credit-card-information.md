...
2. Επιλέξτε τη γραμμή της μεθόδου πληρωμής που θα ενημερώσετε. Στο δεξιό παράθυρο, επιλέξτε **Επεξεργασία**.
3. Ενημερώστε τα στοιχεία της μεθόδου πληρωμής σας, συμπεριλαμβανομένου του ονόματος στην πιστωτική ή χρεωστική κάρτα, τη διεύθυνση χρέωσης ή την ημερομηνία λήξης και, στη συνέχεια, **επιλέξτε Αποθήκευση**.
