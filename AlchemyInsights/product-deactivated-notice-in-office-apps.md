...
ms.locfileid: "54009896"
---
# <a name="product-deactivated-notice-in-microsoft-365-apps"></a>Ειδοποίηση "Το προϊόν έχει απενεργοποιηθεί" στις εφαρμογές του Microsoft 365
