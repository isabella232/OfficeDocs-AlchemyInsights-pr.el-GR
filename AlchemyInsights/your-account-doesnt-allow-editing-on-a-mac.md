...
---
# <a name="fixing-the-microsoft-365-apps-your-account-doesnt-allow-editing-on-a-mac-message"></a>Επιδιόρθωση του μηνύματος εφαρμογών Microsoft 365 "Ο λογαριασμός σας δεν επιτρέπει την επεξεργασία σε Mac"
