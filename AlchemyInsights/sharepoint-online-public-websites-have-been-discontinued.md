...
SharePoint Online δημόσιες τοποθεσίες Web έχουν διακοπεί.
...
Για πληροφορίες σχετικά με τη διακοπή δημόσια τοποθεσία Web, δείτε [λεπτομέρειες σχετικά με τη διαδικασία διακοπή δυνατότητα](https://go.microsoft.com/fwlink/?linkid=866980).
