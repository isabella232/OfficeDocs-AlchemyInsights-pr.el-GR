...
---
# <a name="verify-your-domain-with-namecheap"></a>Επαληθεύστε τον τομέα σας με namecheap
...
Δείτε [Δημιουργία ΕΓΓΡΑΦΏΝ DNS στο namecheap για το Office 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-namecheap) για οδηγίες βήμα προς βήμα.