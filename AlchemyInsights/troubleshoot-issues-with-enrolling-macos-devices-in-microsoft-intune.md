...
3. [Μάθετε πώς να εγγραφεί συσκευές macOS στη Microsoft Intune](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Αναλάβετε τον έλεγχο του τελικού χρήστη του οδηγού για την εγγραφή συσκευών macOS στο Microsoft Intune](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
