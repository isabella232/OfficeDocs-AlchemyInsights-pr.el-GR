...
[Ανατρέξτε στο θέμα οδηγός τελικού χρήστη για την εγγραφή της συσκευής macOS στο Microsoft Intune](https://docs.microsoft.com/intune-user-help/enroll-your-device-in-intune-macos-cp)
