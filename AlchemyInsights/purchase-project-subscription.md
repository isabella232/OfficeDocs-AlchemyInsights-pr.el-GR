...
ms.locfileid: "43158643"
---
# <a name="purchase-project-subscription"></a>Αγορά συνδρομής του Project

Οι διαχειριστές μπορούν να αγοράσουν τη συνδρομή του Project για τον οργανισμό τους από το **κέντρο διαχείρισης του Microsoft 365**.
...
3. Εντοπίστε τα προγράμματα του Project πραγματοποιώντας αναζήτηση στο "Project".

4. Επιλέξτε από τα διάφορα διαθέσιμα προγράμματα Project.
