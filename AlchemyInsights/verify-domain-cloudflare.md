...
ms.locfileid: "43766313"
---
# <a name="verify-your-domain-with-cloudflare"></a>Επαλήθευση του τομέα σας με το Cloudflare
...
Ανατρέξτε [στο θέμα Δημιουργία εγγραφών DNS στο Cloudflare για microsoft 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-cloudflare) για οδηγίες βήμα προς βήμα.