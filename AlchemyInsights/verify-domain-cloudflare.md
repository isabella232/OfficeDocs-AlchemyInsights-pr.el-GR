---
title: Επαληθεύστε τον τομέα σας με Cloudflare
ms.author: pebaum
author: pebaum
manager: mnirkhe
ms.audience: Admin
...
ms.locfileid: "42326183"
---
# <a name="verify-your-domain-with-cloudflare"></a>Επαληθεύστε τον τομέα σας με Cloudflare
...
Δείτε [Δημιουργία ΕΓΓΡΑΦΏΝ DNS στο Cloudflare για το Office 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-cloudflare) για οδηγίες βήμα προς βήμα.