...
---
# <a name="error-while-activation-office-2013-on-remote-desktop-services"></a>Παρουσιάστηκε σφάλμα κατά την ενεργοποίηση Office 2013 σε υπηρεσίες απομακρυσμένης επιφάνειας εργασίας
