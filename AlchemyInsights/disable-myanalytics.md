...
---
# <a name="disable-myanalytics"></a>Απενεργοποίηση MyAnalytics
...
Για πρόσθετες πληροφορίες σχετικά με το MyAnalytics, ανατρέξτε στο θέμα [Εισαγωγή στο MyAnalytics](https://docs.microsoft.com/workplace-analytics/myanalytics/mya-landing-page).
