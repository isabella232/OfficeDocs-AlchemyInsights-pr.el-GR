...
---
# <a name="update-dns-records-at-namecheap"></a>Ενημέρωση εγγραφών DNS στο NameCheap

Χρησιμοποιήστε τις παρακάτω συνδέσεις για να ενημερώσετε τις εγγραφές DNS

- [Δημιουργία εγγραφών DNS στο NameCheap](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-namecheap?view=o365-worldwide)
