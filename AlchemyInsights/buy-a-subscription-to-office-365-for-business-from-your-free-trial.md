...
2. Βρείτε την εγγραφή που θέλετε να αγοράσετε. Στην ενότητα **άδειες χρήσης** , επιλέξτε **εγγραφή αγορών**και ακολουθήστε τα βήματα για να κάνετε ανάληψη ελέγχου.
