...
* Για περισσότερες πληροφορίες σχετικά με τη σύνδεση σε μια ομάδα του Office 365 και την εκτέλεση μιας σύνδεσης ομάδας, ανατρέξτε στο θέμα [Σύνδεση με μια ομάδα του Office 365](https://docs.microsoft.com/sharepoint/dev/transform/modernize-connect-to-office365-group).
