...
Μπορείτε να αλλάξετε την εμφάνιση του παραθύρου λίστας και ανάγνωση μηνυμάτων στις [Ρυθμίσεις διάταξης](https://outlook.live.com/mail/options/mail/layout). Επιλέξτε εάν το μήνυμα ηλεκτρονικού ταχυδρομείου πρέπει να εμφανίζεται ως μεμονωμένα μηνύματα ή συνομιλίες, εάν τα νέα μηνύματα θα πρέπει να εμφανίζεται στο επάνω ή στο κάτω μέρος της λίστας μηνυμάτων και πολλά άλλα.
  
Για να μάθετε περισσότερα, ανατρέξτε στο θέμα [Αλλαγή της εμφάνισης του γραμματοκιβωτίου σας Outlook.com](https://go.microsoft.com/fwlink/p/?linkid=2001401&amp;clcid=0x409).
