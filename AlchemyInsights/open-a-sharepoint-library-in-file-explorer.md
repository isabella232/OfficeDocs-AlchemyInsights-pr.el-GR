...
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>Ανοίξτε μια βιβλιοθήκη του SharePoint, στην Εξερεύνηση αρχείου

1. Μεταβείτε στη βιβλιοθήκη στον Internet Explorer 10 ή 11 του Internet Explorer. 
    
2. Κάντε κλικ στο εικονίδιο προβολής στην επάνω δεξιά γωνία και, στη συνέχεια, κάντε κλικ στην επιλογή **προβολή στην Εξερεύνηση**.
