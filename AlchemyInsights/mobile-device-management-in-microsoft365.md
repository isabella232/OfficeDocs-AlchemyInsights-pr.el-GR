...
ms.locfileid: "47667049"
---
# <a name="mobile-device-management-in-microsoft-365"></a>Διαχείριση κινητών συσκευών στο Microsoft 365

Για περισσότερες πληροφορίες, ανατρέξτε στα θέματα: 

- [Επιλογή μεταξύ βασικής ασφάλειας κινητικότητας και Intune](https://docs.microsoft.com/office365/securitycompliance/choose-between-mdm-and-intune)
...
- [Οδηγός μετεγκατάστασης του Intune](https://docs.microsoft.com/intune/migration-guide)