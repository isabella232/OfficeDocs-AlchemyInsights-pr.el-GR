...
Την ικανότητα του Office 365 εκπαίδευσης είναι υπό αναθεώρηση. Μπορείτε να περιμένετε να λάβετε μια ειδοποίηση στον προσδιορισμό της καταλληλότητά σας πριν λήξει η δοκιμαστική σας έκδοση.
