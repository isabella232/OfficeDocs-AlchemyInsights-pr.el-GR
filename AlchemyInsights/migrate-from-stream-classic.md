...
Για περισσότερες πληροφορίες σχετικά με τη μετεγκατάσταση από την Κλασική ροή στη νέα ροή, ανατρέξτε στο θέμα "Μετεγκατάσταση από [το Microsoft Stream (Κλασικό) στο νέο Microsoft Stream"](https://docs.microsoft.com/stream/classic-migration)