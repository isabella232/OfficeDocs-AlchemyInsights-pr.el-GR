...
Γίνεται αναζήτηση λεξικά στο SharePoint ηλεκτρονικά στο χώρο αποθήκευσης όρων για την ηλεκτρονική του SharePoint που βρίσκεται στο νέο κέντρο διαχείρισης του SharePoint. Για περισσότερες πληροφορίες σχετικά με τον τρόπο προσθήκης ή επεξεργασίας λεξικά αναζήτησης, ανατρέξτε στην ενότητα [Διαχείριση αναζήτησης λεξικά](https://go.microsoft.com/fwlink/?linkid=2044669&amp;clcid=0x409).
