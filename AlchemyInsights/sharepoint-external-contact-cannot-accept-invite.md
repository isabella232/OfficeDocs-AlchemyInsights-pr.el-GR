...
---
# <a name="external-contact-is-unable-to-accept-a-sharing-invite"></a>Εξωτερική επαφή δεν είναι δυνατό να αποδεχτεί μια πρόσκληση κοινής χρήσης

Εάν ένα εξωτερικό δεν μπορεί να αποδεχτεί μια πρόσκληση κοινής χρήσης, Παρακαλώ δοκιμάστε να επισκεφθείτε τις παρακάτω συνδέσεις.
