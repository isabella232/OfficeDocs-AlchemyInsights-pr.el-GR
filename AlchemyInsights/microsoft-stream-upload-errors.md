...
ms.locfileid: "54066112"
---
# <a name="microsoft-stream-upload-errors"></a>Σφάλματα αποστολής του Microsoft Stream

Εάν λαμβάνετε σφάλματα αποστολής στο Microsoft Stream, ανατρέξτε στα σφάλματα [αποστολής μέσω ροής.](/stream/portal-understanding-upload-errors)
