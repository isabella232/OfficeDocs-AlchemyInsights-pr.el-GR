...
Πρέπει να είστε καθολικός διαχειριστής ή διαχειριστής του SharePoint για να αλλάξετε τη ρύθμιση εξωτερικής κοινής χρήσης για μια τοποθεσία (παλαιότερα ονομαζόταν "συλλογή τοποθεσιών"). Οι κάτοχοι τοποθεσιών δεν επιτρέπεται να αλλάξουν αυτήν τη ρύθμιση. 
