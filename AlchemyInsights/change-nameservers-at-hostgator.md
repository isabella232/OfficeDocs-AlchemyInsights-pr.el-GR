...
---
# <a name="change-nameservers-at-hostgator"></a>Αλλαγή των διακομιστή ονομάτων στο Hostgator

[Αλλαγή των διακομιστή ονομάτων για ρύθμιση του Microsoft 365 με το Hostgator](https://docs.microsoft.com/microsoft-365/admin/dns/change-nameservers-at-hostgator?view=o365-worldwide)
