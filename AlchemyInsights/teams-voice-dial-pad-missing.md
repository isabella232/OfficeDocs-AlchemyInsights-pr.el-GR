...
---
# <a name="dial-pad-is-missing-in-microsoft-teams"></a>Το πληκτρολόγιο κλήσης λείπει στο Microsoft Teams 

Εάν το πληκτρολόγιο κλήσης λείπει από το Microsoft Teams, ελέγξτε τα εξής:
