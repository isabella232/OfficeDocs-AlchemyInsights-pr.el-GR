...
Υπάρχουν διάφορες περιοχές που πρέπει να ελέγξετε για να βεβαιωθείτε ότι τα ζωντανά συμβάντα του Microsoft Stream λειτουργούν ομαλά. Για περισσότερες πληροφορίες, ανατρέξτε στο θέμα [Αντιμετώπιση προβλημάτων ζωντανών συμβάντων στο Microsoft Stream](https://docs.microsoft.com/stream/live-event-troubleshooting).
