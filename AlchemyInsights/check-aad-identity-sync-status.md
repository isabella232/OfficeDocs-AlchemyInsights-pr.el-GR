...
---
# <a name="check-aad-identity-sync-status"></a>Έλεγχος κατάστασης συγχρονισμού ταυτότητα AAD

Έλεγχος κατάστασης συγχρονισμού είναι εύκολο: 
  
- Εισέλθετε στο Κέντρο διαχείρισης του Office 365 και επιλέξτε ** DirSync κατάσταση ** στην κεντρική σελίδα. 
    
- Εναλλακτικά, μπορείτε να μεταβείτε στους χρήστες \> ενεργοί χρήστες και στη σελίδα "ενεργοί χρήστες", επιλέξτε περισσότερα \> συγχρονισμού καταλόγου.
