...
3. Για να καταργήσετε την πιστωτική κάρτα ή τον τραπεζικό λογαριασμό, επιλέξτε **"Διαγραφή μεθόδου πληρωμής".**
    ...
    **Σημείωση:** Δεν θα μπορείτε να καταργήσετε μια πιστωτική κάρτα ή έναν τραπεζικό λογαριασμό, εάν αυτή τη στιγμή χρησιμοποιείται για την πληρωμή μιας συνδρομής.
