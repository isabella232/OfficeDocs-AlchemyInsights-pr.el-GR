...
Διαγράψατε κατά λάθος μια ομάδα; Εάν έχουν περάσει λιγότερες από 30 ημέρες από τη στιγμή που διαγράψατε την ομάδα, είστε τυχεροί. Μπορείτε να το επαναφέρετε. Για να το κάνετε αυτό, ακολουθήστε τα παρακάτω βήματα: [Επαναφορά μιας διαγραμμένης ομάδας](https://docs.microsoft.com/microsoftteams/archive-or-delete-a-team#restore-a-deleted-team).
