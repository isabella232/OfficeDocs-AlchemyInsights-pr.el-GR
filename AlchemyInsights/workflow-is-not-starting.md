...
---
# <a name="workflow-is-not-starting"></a>Δεν γίνεται εκκίνηση της ροής εργασίας

- Ροές εργασίας SharePoint 2010 και το 2013 του SharePoint δεν το αρχικό.
...
- Ροές εργασίας SharePoint 2010 καθυστέρηση στην εκκίνηση.

    - Αυτό συμβαίνει εάν η ροή εργασίας ενεργοποιείται σε μεγάλες δέσμες. (για παράδειγμα, όταν πολλά στοιχεία προστίθενται ταυτόχρονα).

    - Ροές εργασίας δεν έχει σχεδιαστεί για να εκτελούνται σε πραγματικό χρόνο, επομένως μια καθυστέρηση είναι η συμπεριφορά οφείλεται στη σχεδίαση.

   -  Εάν η ροή εργασίας είναι πολύπλοκη γλώσσας Extensible Markup αντικειμένου (XMOL), η μεταγλώττιση μπορεί να είναι αργή. Ελέγξτε [αυτό](https://support.microsoft.com/en-us/kb/3043697) το άρθρο.

    - Θα πρέπει να απλοποιήσετε τη ροή εργασίας ή να ξανασχεδιάσετε χρησιμοποιώντας τον τύπο πλατφόρμας ροής εργασίας του Microsoft SharePoint 2013.

    - Το ιστορικό της ροής εργασίας σας έχει γίνει μεγάλη, μπορεί να θέλετε να εκκαθάριση των στοιχείων ή να δημιουργήσετε μια νέα λίστα ιστορικού.
