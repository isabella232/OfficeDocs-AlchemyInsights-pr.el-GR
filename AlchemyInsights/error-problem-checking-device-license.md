---
title: 'Σφάλμα: Παρουσιάστηκε πρόβλημα κατά τον έλεγχο της κατάστασης άδειας χρήσης αυτής της συσκευής'
ms.author: pebaum
author: pebaum
manager: dansimp
ms.date: 03/16/2021
...
---
# <a name="error-there-was-a-problem-checking-this-devices-license-status"></a>Σφάλμα: Παρουσιάστηκε πρόβλημα κατά τον έλεγχο της κατάστασης άδειας χρήσης αυτής της συσκευής
