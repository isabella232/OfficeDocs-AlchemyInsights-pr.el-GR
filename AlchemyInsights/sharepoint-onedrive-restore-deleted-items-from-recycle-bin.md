...
ms.locfileid: "36559913"
---
# <a name="troubleshooting-missing-files-or-folders-in-onedrive-or-sharepoint"></a>Αντιμετώπιση προβλημάτων λείπουν αρχεία ή φακέλους στο OneDrive ή στο SharePoint
