...
---
# <a name="polycom-phones-and-microsoft-teams"></a><span data-ttu-id="b5d2c-102">Τηλέφωνα Polycom και Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="b5d2c-102">Polycom phones and Microsoft Teams</span></span>

<span data-ttu-id="b5d2c-103">Ακολουθήστε αυτή τη [σύνδεση της Polycom](http://www.polycom.com/content/dam/polycom/common/documents/faqs/polycom-phones-and-microsoft-teams-faq-enus.pdf) για πιο συγκεκριμένες πληροφορίες σχετικά με τη χρήση των τηλεφώνων Polycom με το Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="b5d2c-103">Please check this [Polycom link](http://www.polycom.com/content/dam/polycom/common/documents/faqs/polycom-phones-and-microsoft-teams-faq-enus.pdf) for more specific information on using Polycom phones with Microsoft Teams.</span></span>

<span data-ttu-id="b5d2c-104">Εάν θέλετε να μάθετε περισσότερα σχετικά με τη χρήση τηλεφώνων με το Microsoft Teams, ανατρέξτε σε [αυτό το άρθρο](https://docs.microsoft.com/microsoftteams/phones-for-teams).</span><span class="sxs-lookup"><span data-stu-id="b5d2c-104">If you'd like to learn more about using phones with Teams, check out [this article](https://docs.microsoft.com/microsoftteams/phones-for-teams).</span></span>
