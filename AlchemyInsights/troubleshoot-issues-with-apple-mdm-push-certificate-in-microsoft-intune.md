...
1. Αναθεωρήστε [αυτό το έγγραφο](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) για να ρυθμίσετε τις παραμέτρους ή να ανανεώσει το πιστοποιητικό ώθησης Apple MDM. 
