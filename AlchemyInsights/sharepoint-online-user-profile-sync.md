...
Το Microsoft SharePoint χρησιμοποιεί την εργασία συγχρονισμού της υπηρεσίας καταλόγου Active Directory για την εισαγωγή πληροφοριών χαρακτηριστικών χρήστη και ομάδας στην εφαρμογή προφίλ χρήστη (UPA).Για περισσότερες πληροφορίες, ανατρέξτε στο παρακάτω άρθρο.
