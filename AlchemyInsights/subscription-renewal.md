...
ms.locfileid: "58843810"
---
# <a name="subscription-recurring-billing"></a>Περιοδική χρέωση συνδρομής

Εάν θέλετε να γνωρίζετε πότε χρεώνεται η μηνιαία ή η ετήσια συνδρομή σας (εάν η **Περιοδική χρέωση** είναι ενεργοποιημένη) ή πότε λήγει (εάν η **Περιοδική χρέωση** είναι απενεργοποιημένη), ακολουθήστε τα παρακάτω βήματα:
...
4. Στο παράθυρο **Επεξεργασία περιοδικής χρέωσης,** επιλέξτε **Ενεργοποίηση**, **Ενεργοποίηση, ανανέωση μία φορά** ή **Απενεργοποίηση**.
