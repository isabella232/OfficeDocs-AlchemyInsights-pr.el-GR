...
Αν θέλετε να γνωρίζετε πότε θα χρεωθεί η μηνιαία ή ετήσια συνδρομή σας (αν η **περιοδική χρέωση** είναι ενεργοποιημένη) ή να λήξει (αν η **περιοδική χρέωση** είναι απενεργοποιημένη):
  
1. Στο κέντρο διαχείρισης, μεταβείτε στη σελίδα **Χρέωση** \> **[των προϊόντων σας.](https://go.microsoft.com/fwlink/p/?linkid=842054)**

2. Για τη συνδρομή για την οποία θέλετε να μάθετε περισσότερα, στην περιοχή **Χρέωση**, ανατρέξτε στην επιλογή **Νέα ανανέωση ή** Λήξη **ημερομηνίας.**
