...
Απλοποιήστε την πρόσβαση και ασφαλίστε τις εφαρμογές cloud τρίτων κατασκευαστών, όπως το Salesforce και το Dropbox. Use the [Integrate a third-party cloud app with ‎Azure AD‎](https://go.microsoft.com/fwlink/?linkid=2157464) wizard to add apps and configure single sign-on, which reduces or eliminates sign-in prompts.
