...
Για τη μετεγκατάσταση ηλεκτρονικού ταχυδρομείου από ένα σύστημα αλληλογραφίας IMAP, ακολουθήστε αυτήν τη διαδικασία: [μετεγκατάσταση IMAP στο Κέντρο διαχείρισης Microsoft 365](https://support.office.com/article/4682f2e4-f720-4868-91ab-207f5b0c325d)
  
Πολλοί μεγάλοι οργανισμοί θα πρέπει να σχεδιάζει προσεκτικά για να διαχειριστείτε τις προσδοκίες του χρήστη. Το άρθρο [αυτό θα πρέπει να γνωρίζετε σχετικά με τη μετεγκατάσταση των γραμματοκιβωτίων σας IMAP στο Office 365](https://docs.microsoft.com/en-us/Exchange/mailbox-migration/migrating-imap-mailboxes/migrating-imap-mailboxes) θα σας βοηθήσει να διαχειριστείτε την αλλαγή. 
