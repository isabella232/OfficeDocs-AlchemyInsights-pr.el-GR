...
- Θέλω να δημιουργήσω μια υπογραφή ηλεκτρονικού ταχυδρομείου με τη χρήση [του Outlook.com: δημιουργία και προσθήκη υπογραφής ηλεκτρονικού ταχυδρομείου στο Outlook.com](https://support.office.com/article/776d9006-abdf-444e-b5b7-a61821dff034.aspx)

- Θέλω να δημιουργήσω μια καθολική υπογραφή ηλεκτρονικού ταχυδρομείου για όλα τα μηνύματα ηλεκτρονικού ταχυδρομείου που αποστέλλονται από την εταιρεία μου: [δημιουργία υπογραφών και αποποιήσεις σε ολόκληρο τον οργανισμό](https://docs.microsoft.com/microsoft-365/admin/setup/create-signatures-and-disclaimers)

 **Συμβουλή:** Οι υπογραφές σε ολόκληρο τον οργανισμό αναφέρονται ως "αποποιήσεις ευθυνών".
